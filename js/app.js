!function() {
	...
	app = {
     ...
     //        elements.page9.show();
            setTimeout(function(){
                _this.slide(elements.page1.get(0), function() {
                    elements.page1.addClass('page1-fadeout');
                    elements.page2.addClass('page2-fadein');
                    elements.page2.find('div').eq(0).addClass('page2-title');
                    elements.page2.find('div').eq(1).addClass('page2-book-bookmark2');
                    setTimeout(function(){
                        _this.slide(elements.page2.get(0), function() {
                            elements.page2.addClass('page2-fadeout');
                            elements.page3.addClass('page3-fadein');
                            elements.page3.find('div').eq(0).addClass('page3-star');
                            setTimeout(function(){
                                _this.slide(elements.page3.get(0), function() {
                                    elements.page3.addClass('page3-fadeout');
                                    elements.page4.addClass('page4-fadein');
                                    elements.page4.find('div').eq(0).addClass('page4-star');
                                    elements.page4.find('div').eq(1).addClass('page4-title');
                                    setTimeout(function(){
                                        _this.slide(elements.page4.get(0), function() {
                                            ...
                                            elements.page5.find('div').eq(4).addClass('page5-title');
                                            // elements.page5.addClass('page5-photo');
                                            setTimeout(function(){
                                                _this.slide(elements.page5.get(0), function() {
                                                    ...
                                                    elements.page6.find('div').eq(3).addClass('page6-title');
                                                    // elements.page6.addClass('page6-photo');
                                                    setTimeout(function(){
                                                        _this.slide(elements.page6.get(0), function() {
                                                            ...
                                                            elements.page7.find('div').eq(2).addClass('page7-title');
                                                            // elements.page7.addClass('page7-photo');
                                                            setTimeout(function(){
                                                                _this.slide(elements.page7.get(0), function() {
                                                                    ...
                                                                    elements.page8.find('div').eq(3).addClass('page8-title');
                                                                    setTimeout(function() {
                                                                        _this.slide(elements.page8.get(0), function() {
                                                                            elements.page8.addClass('page8-fadeout');
                                                                            elements.page9.addClass('page9-fadein');
                                                                            elements.page9.find('div').eq(0).addClass('page9-book');
                                                                            elements.page9.find('div').eq(1).addClass('page9-title');
                                                                            elements.page9.find('div').eq(2).addClass('page9-click-hint');
                                                                        });
                                                                    }, 6500); 
                                                                });
                                                            },5600)
    	...
    	// });
            elements.page9book.on('tap', function() {
                ...
                $('body').attr('style','overflow:initial;transform:translateY(-'+h*8+'px);-webkit-transform:translateY(-'+h*5+'px)')
        ...
        drawOnCanvas: function(file) { 
            ...
            reader.onload = function (e) { 
                ...
                img.onload = function() { 
                    ...
                    canvas11.height = screenHeight*.31;
                    var offsetX = 0; 
                    var offsetY = 0; 
        ...
        slide: function(obj, leftcallback, rightcallback) {
            ...
            function end(event){
              ...
              if (Number(duration) > 100) {
                if (_this.endPos.y > 60) {
                    
                } else if (_this.endPos.y < -60) {
                  leftcallback();
                }
              }
